...
import { ArrowUpRightIcon, CogIcon, ExternalLinkIcon, FolderCodeIcon } from "lucide-react"
...
export default function ProjectsList({ session }: { session: ReturnType<typeof useSession>["data"] }) {
